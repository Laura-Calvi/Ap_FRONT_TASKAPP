...
const ModalAgregarTarea: React.FC<ModalAgregarTareaProps> = ({showModal, handleClose, createTask}) => {
    const validationSchema = Yup.object( {
        ...
        descripcion: Yup.string().required('Inserte una descripción'),
        ...
        imagen: Yup.string().required('Inserte una imagen'),
            ...
            <Modal.Body>
                <Form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="mb-3 mt-3">
                        ...
                        <textarea 
                        className="form-control" id="descripcion"
                        name="descripcion"
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div className="mb-3 mt-3">
                        ...
                        type="number" 
                        className="form-control" id="tiempo"
                        name="tiempo"
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div className="mb-3 mt-3">
                        ...
                        <input type="text" 
                        className="form-control" id="imagen"
                        name="imagen"
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div className="mb-3 mt-3">
                        ...
                        <input type="text" 
                        className="form-control" id="responsable"
                        name="responsable"
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
